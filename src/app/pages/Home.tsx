...
function ProductSkeleton() {
  return (
    <div className="flex flex-col animate-pulse">
      <div className="aspect-[4/5] bg-gray-200 rounded-xl md:rounded-2xl mb-3 md:mb-6" />
      <div className="h-2 bg-gray-200 rounded w-1/3 mb-2 mx-auto" />
...
export function Home() {
  ...
  // Fetch the 4 most recently added products for the "Glow Edit" showcase.
  useEffect(() => {
    apiFetch('/products')
      .then((data: ApiProduct[]) => setFeaturedProducts((data || []).slice(0, 4)))
